...
1. "jpBlog": 完全な日本語版のMDXブログ記事（1500〜2000文字程度）。
   ...
   - 記事の最後（CTA）には必ず **Amazon.co.jpの書籍リンク** を以下のように挿入すること。
     ...
     [『20代で考える 将来妊娠で困らないための選択』（Amazon）](https://www.amazon.co.jp/dp/B0DV8Z3XZR?tag=ttcguide-blog-22)
...
2. "enBlog": 日本語版と同内容の英語版MDXブログ記事。
   ...
   - 記事の最後（CTA）には必ず **Amazon.comの書籍リンク** を以下のように挿入すること。
     ...
     [Dr. Sato's Guide to Women's Health (Amazon US)](https://www.amazon.com/dp/B0F771VNV5?tag=ttcguide-enblog-22)
