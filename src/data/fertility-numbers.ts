        ...
        items: [
            {
                id: 'ttc-curve',
                value: '15% → 50% → 80% → 90%',
                ja: { label: '妊活1・3・6・12ヶ月の累積妊娠率（保守的な目安）', means: '3→6ヶ月で30ポイント増えるのに、6→12ヶ月では10ポイントしか増えない。', limit: '「待てばいつか」ではない。6ヶ月が方針を見直す分岐点。' },
                en: { label: 'Cumulative pregnancy rate at 1, 3, 6 and 12 months (conservative estimate)', means: 'It climbs 30 points between months 3 and 6, but only 10 points between months 6 and 12.', limit: 'Waiting longer buys much less than people assume — month 6 is the decision point.' },
            ...
            },
            {
                id: 'gnoth',
                value: '38% → 68% → 81% → 92%',
                ja: { label: '排卵日を把握してタイミングを合わせた場合の累積妊娠率（1・3・6・12周期）', means: 'ドイツの前向き研究346名。排卵日を知って臨めばこの水準になる。', limit: '「なんとなくの性交」ではこの数字は出ない。前提条件が結果を大きく変える。' },
                en: { label: 'Cumulative pregnancy rate when ovulation is tracked and sex is timed (1, 3, 6, 12 cycles)', means: 'A German prospective study of 346 couples using natural family planning to time intercourse.', limit: 'These figures do not apply to untimed intercourse — the precondition changes the result substantially.' },
            ...
            },
            {
                id: 'gnoth-6cycle',
                value: '約半数',
                ja: { label: 'タイミングを合わせて6周期経っても妊娠しなかった人のうち、妊娠しにくい要因を持つ割合', means: '6周期は「様子を見る期間」の上限として合理的な根拠がある。', limit: '半数は要因を持たない＝6周期で妊娠しなくても異常とは限らない。' },
                en: { label: 'Share of couples still not pregnant after 6 well-timed cycles who are subfertile or infertile', means: 'This is the evidence behind treating six cycles as the sensible limit for watchful waiting.', limit: 'The other half have no identifiable problem — six cycles without success is not itself abnormal.' },
                source: 'Gnoth C, et al. Hum Reprod. 2003;18(9):1959-66.',
                stability: 'timeless',
            },
            {
                id: 'dunson',
                value: '92% / 86-87% / 82%',
                ja: { label: '12周期以内に妊娠する割合（19〜26歳 / 27〜34歳 / 35〜39歳）', means: '欧州7施設782カップル。性交のタイミングと頻度を補正した解析。', limit: '完全に妊娠できない人は年齢によらず約1%。年齢で増えるのは「妊娠しにくさ」であって「妊娠できなさ」ではない。' },
                en: { label: 'Chance of conceiving within 12 cycles (ages 19–26 / 27–34 / 35–39)', means: '782 couples across seven European centres, adjusted for timing and frequency of intercourse.', limit: 'Absolute sterility stays around 1% at every age. What rises with age is difficulty, not impossibility.' },
            ...
            },
            {
                id: 'leridon',
                value: '75% / 66% / 44%',
                ja: { label: '妊活開始から1年以内に出産に至る割合（30歳 / 35歳 / 40歳開始）', means: '流産と加齢による不妊を織り込んだモデル推計。4年以内なら91% / 84% / 64%。', limit: '開始を30→35歳に遅らせて失う出産を体外受精が取り戻せるのは約半分、35→40歳では30%未満。「困ったら体外受精」では取り返せない。' },
                en: { label: 'Share who achieve a live birth within one year of starting (starting at 30 / 35 / 40)', means: 'A model accounting for miscarriage and age-related infertility. Within four years: 91% / 84% / 64%.', limit: 'ART recovers only about half of the births lost by delaying from 30 to 35, and under 30% of those lost from 35 to 40. "We can always do IVF" does not hold.' },
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                id: 'amh-cutoff',
                value: '1.0 / 2.0 ng/mL',
                ja: { label: '臨床で用いる低値側の線（C＝低め / B＝やや低め）', means: 'AMH 1.0未満を「低め」、1.0〜2.0を「やや低め」として扱う。ESHRE ボローニャ基準の卵巣予備能低下は1.1 ng/mL未満。', limit: '低い＝妊娠できないではない。卵子の質は年齢相応に保たれる。' },
                en: { label: 'The low-side thresholds used in clinic (1.0 and 2.0 ng/mL)', means: 'Below 1.0 is treated as low; 1.0–2.0 as mildly low. The ESHRE Bologna criteria define diminished reserve as under 1.1 ng/mL.', limit: 'Low reserve does not mean you cannot conceive — egg quality still tracks your age, not your AMH.' },
                source: 'ESHRE Bologna criteria (2011) ほか',
                stability: 'changing',
            },
            {
                id: 'amh-high',
                value: '20代 4.0 / 30代 2.8 ng/mL',
                ja: { label: '高値側の年齢別カットオフ（PCOSの評価に使う）', means: '日本産科婦人科学会PCOS診断基準（2024）。40歳以上は基準に記載がないため高値判定を行わない。', limit: 'AMHが高いだけではPCOSと診断できない。月経異常・エコー所見・ホルモン値と合わせて判断する。' },
                en: { label: 'Age-specific high-side cut-offs used in PCOS assessment (4.0 in the 20s, 2.8 in the 30s)', means: 'From the JSOG PCOS diagnostic criteria (2024). No high-side判定 is applied from age 40, as the criteria do not specify one.', limit: 'A high AMH alone does not diagnose PCOS — cycle irregularity, ultrasound findings and hormone levels are all required.' },
