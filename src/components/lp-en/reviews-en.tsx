            ...
            <div className="max-w-[800px] mx-auto">
                <FadeIn className="text-center mb-[var(--spacing-lg)]">
                    ...
                    <div className="inline-flex flex-col items-center gap-2">
                        ...
                        <a href="https://www.amazon.co.jp/Doctor%E2%80%99s-Guide-Womens-Health-Preconception/dp/B0F7XTWJ3X/ref=tmm_pap_swatch_0" target="_blank" rel="noreferrer" className="text-[0.8rem] text-[var(--color-sage)] hover:underline ml-1">
