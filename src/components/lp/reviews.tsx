            ...
            <div className="max-w-[800px] mx-auto">
                <FadeIn className="text-center mb-[var(--spacing-lg)]">
                    ...
                    <div className="inline-flex flex-col items-center gap-2">
                        ...
                        <a href="https://www.amazon.co.jp/dp/B0DV8Z3XZR?tag=ttcguide-lp-22" target="_blank" rel="noreferrer" onClick={() => trackCtaClick("lp-jp", "cta", "reviews")} className="text-[0.8rem] text-[var(--color-sage)] hover:underline ml-1">
                            → Amazonで全てのレビューを見る
                        </a>
                    </div>
                </FadeIn>
                    ...
                    {reviews.map((review, idx) => (
                        <FadeIn key={idx} delay={idx * 0.1}>
                            <div className="bg-white rounded-[16px] p-6 md:p-8 shadow-sm relative">
                                ...
                                <p className="text-[0.85rem] text-[var(--color-text-mid)] font-medium">
                                    — {review.name}（Amazon）
                                </p>
                            </div>
                        </FadeIn>
